...
export default function Projects(props) {
  const [allProjects, setProjects] = useState([
    ...
    {img: "", title: "Burlington Code Academy Curriculum", desc: "BCA is a 12 week intensive fullstack bootcamp-style course focused on web development. While the original curriculum was designed by Josh Burke (the director of education) during my tenure as lead instructor I optimized the curriculum, modified it for use in an online format, kept it up to date, rearranged, and rewrote it several times to keep it up to date, and focus class time on subjects students traditionally struggled with to the point that the curriculum was 99% my work by the time I left 3 years later. I'm sure the current instructors have continued to modify the curriculum to match their teaching styles, and as tech changes, so you might have to dig back through the commit history to find the version I wrote (I'm Habenzy on Github).", link: "https://github.com/BurlingtonCodeAcademy/sdb-summer-2021-curriculum", linkText: "Check out the full curriculum here (in markdown format)"},

    {img: "", title: "Burlington Code Academy LMS", desc: "The BCA LMS was my first major software project. I worked on it in conjunction with our head of development (also Josh Burke), and in house software developer Nick. I was responsible for the student progress tracking, and slide deck integration portions of the system.", link: "Talk to the folks at BCA for more info!", linkText: "https://burlingtoncodeacademy.com/"},
