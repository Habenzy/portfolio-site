...
export default function Projects(props) {
  const [allProjects, setProjects] = useState([
    ...
    {img: "", title: "Tic Tac Toe", desc: "Built during my time as a student at BCA it's Tic Tac Toe! The AI is pretty good, but not perfect. Play around with some of the different modes and features to see what's in there.", link: "", linkText: ""}
  ]);
  return (
